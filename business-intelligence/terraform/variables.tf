...
variable "service" {
  type        = string
  description = "service name i.e dss"
}

variable "service_identifier" {
  type        = string
  description = "service identifier i.e delinea"
}
...
# variable "wsus_qsconfig_id_ring2" {
#   type        = string
#   description = "WSUS quick setup config ID for ring 2"
# }

# variable "wsus_qsconfig_id_ring3" {
#   type        = string
#   description = "WSUS quick setup config ID for ring 3"
# }

# variable "wsus_qsconfig_id_ring4" {
#   type        = string
#   description = "WSUS quick setup config ID for ring 4"
# }
