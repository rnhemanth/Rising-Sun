locals {
  ...
  remote_identifier = "business-intelligence"
  identifier       = "network"
  ...
  common           = read_terragrunt_config("${get_terragrunt_dir()}/../../../../../../../terragrunt/${local.env}/environment.terragrunt.hcl")
...
provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      account_state   = "$(local.env)"  
      programme_name  = "adelaide"
      project_name    = "brisbane"
      project_code    = "prj001170"
